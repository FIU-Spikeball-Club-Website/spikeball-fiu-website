        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/panthersroundnet/" className="text-gray-300 hover:text-white" aria-label="Instagram">
              ...
              <a href="https://www.youtube.com/@PanthersRoundnet-sp5vd" className="text-gray-300 hover:text-white" aria-label="YouTube">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
              <a href="https://linktr.ee/panthers_roundnet" className="text-gray-300 hover:text-white" aria-label="Linktree">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-purple-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0">
              <ul className="flex space-x-6 text-sm text-gray-400">
                ...
                <li><a href="https://spikeball.com/" className="hover:text-white">Spikeball™</a></li>
              </ul>
            </div>
          </div>
        </div>
